...
| 観点 | Hemisphere | Pyramid |
| --- | --- | --- |
| 稜線の有無 | 稜線なし (全方向対称) | 4 本の明確な稜線 |
| 浸食の見え方 | 流路が全方向に均等に出る | 稜線で流路が分岐しやすい |
| D8 アーティファクトの目立ちやすさ | 均質すぎて対称パターンが出やすい | 稜線の非対称が D8 をほぼ隠す |
| Thermal パスの検証 | しやすい (崩れが均質) | 稜線 vs 谷の違いが見えやすい |
...
| パラメータ | 直感的な役割 |
| --- | --- |
| `Shape Type` | Hemisphere か Pyramid の選択 |
